...
export const initial:Progress={answered:0,correct:0,studyMinutes:0,streak:0,favorites:[],topicStatus:{},confidence:{},completedSessions:[],errors:[],reviews:{},simulationHistory:[],generatedQuestions:[],attemptHistory:[],studyHistory:[],aiChats:{},dailyPlans:{},questionReviews:[],profile:{name:""},settings:{dailyGoal:90,hours:1.5,weekdays:[1,2,3,4,5,6],specificPriority:60,examDate:"",weights:{edital:30,frequency:25,errors:25,overdue:20}}};
const KEY="ebtt-ifmt-progress-v2";
let remoteReady=false;
function normalize(old:Partial<Progress>):Progress{return{...initial,...old,profile:{...initial.profile,...old.profile},settings:{...initial.settings,...old.settings,weights:{...initial.settings.weights,...old.settings?.weights}},generatedQuestions:old.generatedQuestions||[],attemptHistory:old.attemptHistory||[],studyHistory:old.studyHistory||[],aiChats:old.aiChats||{},dailyPlans:old.dailyPlans||{},questionReviews:old.questionReviews||[]}}
